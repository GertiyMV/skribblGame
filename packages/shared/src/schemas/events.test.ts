...
test('create_room: trims nickname and validates payload', () => {
...
test('join_room: rejects roomId not matching contract', () => {
...
test('draw: rejects payload with too many points', () => {
...
test('guess_result: supports ok=true and ok=false variants', () => {
